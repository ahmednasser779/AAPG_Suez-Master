...
public class Blog_Query {
    /** Tag for the log messages */
    private static final String LOG_TAG = net.aapgsuez.aapgsuez.Blog.Blog_Query.class.getSimpleName();
     ...
     */
    public static List<BlogObject> fetchBlogData(String requestUrl) {
        // Create URL object
        ...
        List<BlogObject> blog = extractFeatureFromJson(jsonResponse);
     ...
     */
    private static List<BlogObject> extractFeatureFromJson(String blogJSON) {
        ...
        List<BlogObject> blog = new ArrayList<>();
        ...
        try {
            ...
            for (int i = 0; i < blogArray.length(); i++) {
                ...
                String desc = currentblog.getString("description");
                String img = currentblog.getString("image");
                String url = currentblog.getString("link");

                // Create a new {@link Events} object with the name, date, desc,img
                // and url from the JSON response.
                BlogObject blogObject = new BlogObject(name,date,desc,img,url);
            ...
            Log.e("QueryUtils", "Problem parsing the blog JSON results", e);
        }
